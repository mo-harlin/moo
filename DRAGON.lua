...
sudo_users = {SUDO,1932226438,1914852231}   
...
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'اسم المستخدم » '
end  
return var
end 
...
local DRAGON_Msg = { 
'⌯︙أهلآ بك في بوت  '..Namebot.. ' ⌯︙اختصاص البوت حماية المجموعات\n ⌯︙لتفعيل البوت عليك اتباع مايلي ... \n ⌯︙اضف البوت الى مجموعتك \n ⌯︙ارفعه ادمن {مشرف} \n ⌯︙ارفعه ادمن {مشرف} \n ⌯︙ارسل كلمة { تفعيل } ليتم تفعيل المجموعه \⌯︙وسيتم رفع مشرفين المجموعه تلقائين',
} 
...
if DevSoFi(msg) then
local bl = '⌯︙انت الان المطور الاساسي في البوت  يمكنك تحكم في البوتات من الكيبورد قم بأختيار ماتريده من الازار في الاسفل↑↓'
local keyboard = {
{'﴿ضع اسم للبوت﴾','﴿معلومات الكيبورد﴾'},
{'﴿المطور﴾','﴿الاحصائيات﴾'},
{'﴿قسم المبرمجين﴾','﴿قسم اضف﴾'},
{'﴿قسم التفعيل﴾','﴿قسم الحمايه﴾'},
{'﴿قسم الاذاعه﴾'},
...
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/dv_harlin/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if text == '﴿قسم اضف﴾' and DevSoFi(msg) then 
...
if text == '﴿قسم التفعيل﴾' and DevSoFi(msg) then 
...
local Text = 'قسم الحمايه في المطورين والثانوين والخ...'
local Key = {
...
send(msg.chat_id_,0,"⌯︙اسم المستخدم »  : {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..DRAGON_Msg.."] \n")
else
send(msg.chat_id_,0,"⌯︙اسم المستخدم »  : {["..data.first_name_.."](T.ME/SO_NOOVA)}\n⌯︙["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
local Text = [[
[᭙ꫀꪶᥴꪮꪑꫀ 𝓽ꪮ ᦔꪮꪊ𝘳ᥴꫀ ꪀꪮꪜꪖ](http://t.me/SO_NOOVA)
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ꪀꪮꪜꪖ ᦔꫀꪜꫀꪶꪮρꫀ𝘳',url="t.me/G_W_P"},{text = 'ꪀꪮꪜꪖ ᦔꫀꪜꫀꪶꪮρꫀ𝘳',url="t.me/MaRtEn_Vs_WoRLD"}},
{{text = 'ᦔꪮꪊ𝘳ᥴꫀ ꪀꪮꪜꪖ', url="t.me/SO_NOOVA"}},
}
local msg_id = msg.id_/2097152/0.5
...
------------------------------------------------------------------------
if text == 'مميزات' or text == 'مميزات نوفا' then
local Text = [[ 
...
local  statuss  = '\n⌯︙تم رفع اسم المستخدم »  متوحد في الجروب \n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯︙اسم المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOOVA')..')'
status  = '\n⌯︙تم تنزيل اسم المستخدم »  متوحد في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯︙اسم المستخدم »  » ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOOVA')..')'
local statuss = '\n⌯︙تم رفع اسم المستخدم »  علي زبك بنجاح\n⌯︙تفضل ابدا نيك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
database:sadd(bot_id..'Zahf:User'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n⌯︙اسم المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 's_o_op')..')'
...
usertext = '\n⌯︙اسم المستخدم »  ['..result.title_..'](t.me/'..(username or 'GLOBLA')..')'
status  = '\n⌯︙تم حظره'
texts = usertext..status
chat_kick(msg.chat_id_, result.id_)
send(msg.chat_id_, msg.id_, texts)
...
local t = "\n⌯︙ اسم المستخدم » ["..User_id .."] يصيح المشرفين \n- - - - - - - - - - - - - - - - -\n"
k = 0
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري نور عنيا🥺🤍](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مطوري الثاني حته مني 😍♥](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت المطور بس الصغنن 🌝♥](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[نت المالك هن يعني حاجه فوق فوق راسي 😂♥](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه??🤦‍♂️](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂♥](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت المدير يعني الروم تحت سيطرتك😹♥](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ انت مميز ابن ناس 😊♥](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = '[ عضو قميل 🌝♥](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'الـمـطـور', url="http://t.me/"..sudos.UserName},
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data)  
local Text = { 
"سعر الكشف 20 جني مش منزل عن كدا ​​​​​​​​😂​​​​😂​​​​​​​​​​​​​​​​❤️",
"سعر الكشف مجاني لانك فقير مجلخ ​​​​​​​​​​​​​​​​​🥰​​​​​​​​​​​​​​​​❤️",
"مبروك المدام حامل ​​​​😂​​​​😂​​​​😂​​​​​​​​​​​​​​​​❤️",
} 
...
send(msg.chat_id_, msg.id_,'⌯︙انت دخلت عبر الروم يبنلقمر ​​​​​​​​​​​​​​​​​🥰​​​​​​​​​​​​​​​​❤️') 
end
end,nil)
else
...
Text = '⌯︙تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹​​​​​​​​​​​​​​​​❤️'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = '⌯︙بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾​​​​​​​​​​​​​​​​❤️'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n⌯︙تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹​​​​​​​​​​​​​​​​❤️'
else
Text = '\n⌯︙بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹​​​​​​​​​​​​​​​​❤️'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
{
{text = 'ʙᴀᴄᴋ', callback_data="/help90"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
- - - - - - - - - - - - - - - - -
🎖️ قفل او فتح + الامر
🎖️ قفل او فتح الامر بالطرد
🎖️ قفل او فتح الامر بالكتم
🎖️ قفل او فتح الامر بالتقييد
- - - - - - - - - - - - - - - - -
🎖️ الروابط
🎖️ المعرفات
🎖️ الشارحه
