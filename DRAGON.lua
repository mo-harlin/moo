...
local config = loadfile("./NOVA.lua")() 
return config 
end 
_redis = load_redis()  
--------------------------------------------------------------------------------------------------------------
...
if text == 'مطورين نوفا' then
local Text = 'مبرمجين سورس نوفا لدخول الي حسابتهم'
local Key = {
{'المبرمجين'},
...
send(msg.chat_id_, msg.id_," ⌯︙تم تفغيل النسخه التلقائيه") 
...
send(msg.chat_id_, msg.id_,' ⌯︙اصدار سورس نوفا{ 1.5x⌯︙}')
end
if text == '/start' and DevSoFi(msg) then 
local Text = '⌯︙مرحبا بك في سورس نوفا 🧚‍♀❤️ \n ⌯︙انت المطور الاساسي واليك كيبورد التحكم في البوت 😊❤️ \n.⌯︙[اضغط هنا وانضم الي قناه السورس](t.me/SO_NOOVA)'
keyboard = {} 
keyboard.inline_keyboard = {
{text = 'مـطـور الـبـوت 🌿☕', url="http://t.me/"..sudos.UserName},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/dv_harlin/399&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local Text = 'اوامر المسح واضف مثلا اضف رد عام مسح رد عام'
local Key = {
...
local Text = 'اوامر الاذاعه لعمل اذاعه في البوت'
local Key = {
{'اذاعه ','اذاعه خاص '},
{'اذاعه بالتثبيت '},
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
...
usertext = '\n ⌯︙العضو  »  ['..result.title_..'](t.me/'..(username or 'SO_NOOVA')..')'
status  = '\n ⌯︙تم ترقيته مطور'
...
send(msg.chat_id_, msg.id_,'•  ⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ⌯︙العضو  »  ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_NOOVA')..') \n ⌯︙'..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
if text == 'سورس' or text == 'السورس' or text == 'ياسورس' or text == 'يا سورس' then  
local Text = [[
[📮︙𝙬𝙚𝙡𝙘𝙢𝙚 𝙩𝙤 𝙨𝙤𝙪𝙧𝙘𝙚 𝙣𝙤𝙫𝙖](t.me/SO_NOOVA)
[-------------------------------------](t.me/SO_NOOVA)
[📬︙𝙗𝙚𝙨𝙩 𝙨𝙤𝙪𝙧𝙘𝙚 𝙣𝙤 𝙩𝙚𝙞𝙡𝙜𝙧𝙖𝙢](t.me/SO_NOOVA)
[--------------------------------------](t.me/SO_NOOVA)
[📌︙𝙣𝙤𝙫𝙖 𝙞𝙣 𝙗𝙤𝙪𝙩𝙩𝙤𝙨 𝙗𝙚𝙡𝙤𝙡](t.me/SO_NOOVA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝙙𝙫 𝙝𝙖𝙧𝙞𝙡𝙣 ⌯',url="t.me/G_W_P"},{text = '⌯ 𝙙𝙫 𝙢𝙖𝙧𝙚𝙩𝙣 ⌯',url="t.me/MaRTeN_Vs_WoRLd"}},
{{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/dv_harlin/399&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
keyboard.inline_keyboard = {
{{text = '⌯ 𝙙𝙫 𝙝𝙖𝙧𝙞𝙡𝙣 ⌯',url="t.me/G_W_P"},{text = '⌯ 𝙙𝙫 𝙢𝙖𝙧𝙚𝙩𝙣 ⌯',url="t.me/MaRTeN_Vs_WoRLd"}},
{{text = '⌯ 𝙩𝙬 𝙣𝙤𝙫𝙖 ⌯',url="t.me/G_W_P_2_BOT"}},
{{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/dv_harlin/399&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if text == 'مارتن' or text == 'مارتن التونز' or text == 'توام هارلين' then
local Text = [[
مارتن مبرمج سورس نوفا لوحابب تتواصل معاه ❤️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ 𝙙𝙫 𝙢𝙖𝙧𝙚𝙩𝙣 ⌯',url="t.me/MaRTeN_Vs_WoRLd"}},
{{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"}},
}
local msg_id = msg.id_/2097152/0.5
...
keyboard.inline_keyboard = {  
{
{text = 'العاب السورس', callback_data="/nova1"},{text = 'العاب متطوره', callback_data="/nova1"},
},
{
{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"},
},
...
--------------------------------------------------------------------------------------------------------------
if text == 'تحديث الملفات' and DevSoFi(msg) then    
dofile('DRAGON.lua')  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ⌯︙العضو  »  ['..result.title_..'](t.me/'..(text1[3] or 'SO_NOOVA')..')'..'\n ⌯︙تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local Text ='تم اختيار لك بيك جمد شبهك 🌚❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"}}, 
} 
...
if text == "صوره" and not  database:get(bot_id.."sing:for:me"..msg.chat_id_) then 
ght = math.random(1,28); 
local Text ='تم اختيار لك صوره جمده شبهك 🌚❤️' 
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"}}, 
} 
...
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/SO_NOOVA/'..ght..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
database:set(bot_id.."SO_NOOVA:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"⌯︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."SO_NOOVA:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."SO_NOOVA:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'المطور الاساسي نور عيني 🥺❤️'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت 🌿☕', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'انت مطوري الثاني حته مني 😍♥'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت 🌿☕', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'انت المطور بس الصغنن 🥰♥'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت 🌿☕', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه 🤭❤️'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت 🌿☕', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر 😂♥'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت 🌿☕', url="http://t.me/"..sudos.UserName},
...
local msg_id = msg.id_/2097152/0.5  
local textt = 'انت المدير يعني الروم تحت سيطرتك 😹♥'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'مـطـور الـبـوت 🌿☕', url="http://t.me/"..sudos.UserName},
...
send(msg.chat_id_,msg.id_, 'اكتب زخرفه + الاسم للي هتزخرفه مثال زخرفه نوفا') 
return false
end
...
send(msg.chat_id_,msg.id_, '⌯︙لا انا شغال متحورش 😂😂😂❤️') 
return false
end
...
send(msg.chat_id_,msg.id_, 'اهلا عزيزي تم قفل المحن بنجاح اتمحونوا بف عشان المراره 😂😂😂❤️') 
return false
end
end
end
...
if result.id_ then
send(msg.chat_id_, msg.id_,' ⌯︙تع يعم كلم الود دا قرفني 🙄❤️ [@'..username..']') 
return false
end
end
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil)
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ⌯︙هوا ابن الكلب دا الي ضافك 🤗❤️ »  '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' ⌯︙انت دخلت عبر الرابط يبنلقمر 🥰❤️') 
end
end,nil)
else
...
keyboard.inline_keyboard = {
{
{text = '❴م1❵', callback_data="/help3"},
},
{
{text = '❴م2❵', callback_data="/help5"},{text = '❴م3❵', callback_data="/help6"},
},
{
{text = '❴م4❵', callback_data="/help7"},{text = '❴م5❵', callback_data="/help4"},
},
{
{text = '❴م6❵', callback_data="/help1"},{text = '❴م7❵', callback_data="/help2"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{
{text = 'القائمه الرائسيه', callback_data="/help90"},
},
}
...
{{text = 'SkodaHockey1 ', url="https://t.me/gamee?game=SkodaHockey1"},{text = 'SummerLove', url="https://t.me/gamee?game=SummerLove"}},  
{{text = 'SmartUpShark', url="https://t.me/gamee?game=SmartUpShark"},{text = 'SpikyFish3', url="https://t.me/gamee?game=SpikyFish3"}},  
{{text = 'القائمه الرائسيه', callback_data="/uunova"}},
{{text = '⌯ 𝙏𝙚𝙢𝙖 𝙣𝙤𝙫𝙖 ⌯', url="t.me/SO_NOOVA"}},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
