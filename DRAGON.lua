...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠕 الـعـضو   ⋙ [『'..Rutba(msg.sender_user_id_,msg.chat_id_)..'』](T.ME/'..(data.username_ or 'SO_NOVA')..') \n 𖠕 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
local msa3d = database:get(bot_id.."id:msa3d:nov")
if text == 'الغاء' or text == 'الغاء 𖠕' then   
send(msg.chat_id_, msg.id_," 𖠕 تم الغاء الرساله للمطور")
...
sendText(1932226438,"᥀︙. هناك شخص يريدك يا سيدي هارلين \n᥀︙الشخص  {"..Name.."}\n᥀︙اسم الجروب {"..NameChat.."}\n᥀︙ايدي الجروب { `"..msg.chat_id_.."` }\n᥀︙رابط الجروب \n [ "..LinkGroup.." ]\n   𖠕رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then 
if database:get(bot_id.."NoVa:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then   
return  
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك") 
end 
database:setex(bot_id..'NoVa:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(argg,dataa)  
...
local NoVa = 'https://t.me/MRT_NOVA/10'
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if not my_ph then
send(msg.chat_id_, msg.id_," 𖠕انا مين معطله") 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result.username_ then
...
local Text ="𖠕 ارسل الاذاعة لارسلها الي المطور الاساسي و المساعد "
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᦔꪮꪊ𝘳ᥴꫀ ꪀꪮꪜꪖ',url='http://t.me/SO_NOVA'}},
}
