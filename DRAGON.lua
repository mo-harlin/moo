...
local bl = '𖠕انت الان المطور الثانوي في البوت \n𖠕 سورس نوفا\n 𖠕يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/SO_NOVA)'
local keyboard = {
{'الاحصائيات'},
{'المطور','المساعد'},
{'معلومات الكيبورد'},
...
local Namebot = (bot_data:get(ban_id..'Name:Bot') or 'نوفا') 
local NOVA_Msg = { 
...
if text == '/start' or text == 'رجوع' then  
if msa3d(msg) then
local bl = '𖠕انت الان المطور الاساسي في البوت \n𖠕 سورس نوفا\n 𖠕يمكنك تحكم في البوتات من الكيبورد أسفل \n[تابع جديدنا](t.me/SO_NOVA)'
local keyboard = {
...
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = 'قناه السورس️️', url="t.me/SO_NOVA"}}, 
} 
local msg_id = msg.id_/2097152/0.5 
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/dv_harlin/4&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
...
send(msg.chat_id_, msg.id_,'اهلا بك عزيزي 𖠕 \nلايمكنك استخدام البوت 𖠕 \nعليك الاشتراك في القناة 𖠕 \nاشترك اولا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if text == 'الغاء' or text == 'الغاء 𖠕' then   
...
if text and text:match("^وضع قناة الاشتراك 𖠕$") and DevSoFi(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' 𖠕 حسنآ ارسل لي معرف القناة')
return false  
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠕  العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n 𖠕  الايدي ↫ `'..result.sender_user_id_..'`\n 𖠕  تم تنزيله ادمن من الجروب بكل الصلاحيات'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=false&can_restrict_members=false&can_pin_messages=false&can_promote_members=false")
end,nil)
end
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'𖠕تستطيع التنظيف 1000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,"𖠕تم حذف ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,'𖠕لا يمكنني تعديل  او وضع لقب ليس لدي صلاحيه\n 𖠕قم بترقيتي جميع الصلاحيات او صلاحية اضافه مشرف ') 
return false  
end
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n𖠕 العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..') '
status  = '\n𖠕 الايدي ↫ '..result.sender_user_id_..'\n𖠕تم ضافه {'..timsh..'} كلقب له'
send(msg.chat_id_, msg.id_, usertext..status)
https.request("https://api.telegram.org/bot"..token.."/promoteChatMember?chat_id=" .. msg.chat_id_ .. "&user_id=" ..result.sender_user_id_.."&can_change_info=false&can_delete_messages=false&can_invite_users=True&can_restrict_members=false&can_pin_messages=True&can_promote_members=false")
...
send(msg.chat_id_, msg.id_,'𖠕وينك وين القب ') 
else
send(msg.chat_id_, msg.id_,'𖠕لقبك هو : '..GeId.result.custom_title) 
end
end
...
send(msg.chat_id_, msg.id_,'\n 𖠕صلاحيات البوت هي\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n𖠕  علامة ال {✔️} تعني مفعل\n𖠕  علامة ال {✖} تعني غير مفعل\n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n𖠕تغير معلومات المجموعة ↞ '..INf..'\n𖠕حذف الرسائل ↞ '..DEL..'\n𖠕حظر المستخدمين ↞ '..REs..'\n𖠕دعوة المستخدمين ↞ '..INv..'\n𖠕ثتبيت الرسالة ↞ '..Pin..'\n𖠕اضافة مشرفين ↞ '..PRo)   
end
end
...
local t = "\n𖠕المستخدم ~ ["..User_id .."] يصيح المشرفين \n╾╾╾╾╾╾╾╾╾╾╾╾╾╾╾╸\n"
k = 0
...
return send(msg.chat_id_, msg.id_,"𖠕ارسل الرد الذي اريد اضافته")
end
...
return send(msg.chat_id_, msg.id_,"𖠕ارسل الان الكلمه لحذفها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖠕تم حفظ الرد الاول ارسل الرد الثاني")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖠕تم حفظ الرد الثاني ارسل الرد الثالث")
return false  
end  
end
if text then  
...
send(msg.chat_id_, msg.id_,"𖠕تم حفظ الرد")
return false  
end  
end
if text then
...
send_inlin_key(msg.chat_id_,"𖠕قم بتأكيد العمليه الان",_key,msg.id_)
return false
else
...
Text = ' *𖠕تم تفعيل امر اطردني*'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' *𖠕بالتاكيد تم تفعيل امر اطردني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n *𖠕تم تعطيل امر اطردني*'
else
Text = '\n *𖠕بالتاكيد تم تعطيل امر اطردني*'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
if not Mod(msg) then
send(msg.chat_id_, msg.id_,'𖠕هاذا الامر خاص بالادمنيه\n𖠕ارسل {⑩} لعرض اوامر الاعضاء')
return false
end
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" 𖠕ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" 𖠕البوت ليس ادمن يرجى ترقيتي !*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" 𖠕عذرا لا استطيع طرد ادمنية الكروب*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" 𖠕تم الطرد بنجاح*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end,nil)   
end
