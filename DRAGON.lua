...
send(msg.chat_id_, msg.id_,' ❦︎︙ اصدار سورس نوفا { s: 6.7}')
end
...
usertext = '\n ❦︎︙ العضو ↫ ['..result.title_..'](t.me/'..(username or 'textchuser')..')'
status  = '\n ❦︎︙ تم ترقيته مطور'
...
usertext = '\n ❦︎︙ العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ❦︎︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❦︎︙ العضو ↫ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ❦︎︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0," ❦︎︙ العضو : {["..data.first_name_.."](t.me/SO_NOVA)}\n ❦︎︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, " ❦︎︙ عذرا ↫ {["..data.first_name_.."](t.me/SO_NOVA)}\n ❦︎︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
sendText(SUDO,"❦︎︙هناك من بحاجه الى مساعده \n❦︎︙الشخص  {"..Name.."}\n❦︎︙اسم الجروب {"..NameChat.."}\n❦︎︙ايدي الجروب {`"..msg.chat_id_.."`}\n❦︎︙رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
...
sendText(1932226438,"❦︎︙. هناك شخص يريدك يا سيدي هارلين \n❦︎︙الشخص  {"..Name.."}\n❦︎︙اسم الجروب {"..NameChat.."}\n❦︎︙ايدي الجروب { `"..msg.chat_id_.."` }\n❦︎︙رابط الجروب \n [ "..LinkGroup.." ]\n    ❦︎︙رابط الرساله \n https://t.me/c/"..chatid.."/"..msg_id.."   ",0,'md')
end,nil)
end,nil)
end
...
sendText(1984063192,"❦︎︙. هناك شخص يريدك يا سيدي  مارتن \n❦︎︙الشخص  {"..Name.."}\n❦︎︙اسم الجروب {"..NameChat.."}\n❦︎︙ايدي الجروب {`"..msg.chat_id_.."`}\n❦︎︙رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
...
if not my_ph then
send(msg.chat_id_, msg.id_," ❦︎︙ مريم  معطله") 
return false  
end
local Text = [[
...
local Text = [[  
 🔰 اهلا في قائمه الالعاب المتطوره سورس نوفا
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,' ❦︎︙ بواسطه ↫ ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ❦︎︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' ❦︎︙ بواسطه ↫ ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'textchuser')..') \n ❦︎︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
function(arg,data) 
usertext = '\n ❦︎︙ العضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or '@SO_NOVA')..')'
...
usertext = '\n ❦︎︙ العضو ↫ ['..result.title_..'](t.me/'..(username or '@SO_NOVA')..')'
...
if Get_info then
local TextS = "\n ❦︎︙ اهلا بك في متجر ملفات نوفا\n ❦︎︙ ملفات السورس ↓\n◍- - - - - - - -×- - - - - - - -◍\n\n"
local TextE = "\n◍- - - - - - - -×- - - - - - - -◍\n ❦︎︙ علامة تعني { ✔️ } ملف مفعل\n ❦︎︙ علامة تعني { ✖ } ملف معطل\n ❦︎︙ قناة سورس نوفا ↓\n".." ❦︎︙ [اضغط هنا لدخول](t.me/SO_NOVA) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_," ❦︎︙ عذرا الملف لايدعم سورس نوفا \n") 
end
return false
end
...
local Text = "❦︎︙  منشئ الجروب  ⋙ ["..b.first_name_.."](tg://user?id="..b.id_..")\n"..getbio(b.id_):gsub('لايوجد','')
local msg_id = msg.id_/2097152/0.5
keyboard = {} 
keyboard.inline_keyboard = {
...
sendText(b.id_,"❦︎︙ مرحبا عزيزي المنشئ هناك شخص يريدك \n❦︎︙ الشخص  {"..Name.."}\n❦︎︙ اسم الجروب {"..NameChat.."}\n❦︎︙ ايدي الجروب {"..msg.chat_id_.."}\n❦︎︙ رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end,nil)
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❦︎︙ الـعـضو   ⋙ ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..')'
status  = '\n ❦︎︙ تم ترقيته مدير عام'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
usertext = '\n ❦︎︙ الـعـضو   ⋙ ['..result.title_..'](t.me/'..(username or 'SO_NOVA')..')'
status  = '\n ❦︎︙ تم ترقيته مدير عام'
texts = usertext..status
else
texts = ' ❦︎︙ لا يوجد حساب بهاذا المعرف'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n ❦︎︙ لعضو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ❦︎︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n ❦︎︙ العضو ↫ '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❦︎︙ العضــو ↫ ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❦︎︙ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
local  statuss  = '\n ❦︎︙ تم رفع قلب اوس اوس في الجروب\n'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n ❦︎︙ العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'textchuser')..')'
status  = '\n ❦︎︙ تم تنزيل قلب اوس اوس من الجروب\n'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n ❦︎︙ العضو ↫ ['..result.title_..'](t.me/'..(text1[3] or 'textchuser')..')'..'\n ❦︎︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ahmed_1asd/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/a7a_00_1/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/swary0/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendphoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/jrumdi/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/jdjie1/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/jndjkdkd/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/y_giu/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/agany001/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendvideo?chat_id=' .. msg.chat_id_ .. '&video=https://t.me/jfudb637/'..NOVA..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
send_inlin_key(msg.chat_id_,"❦︎︙قم بتأكيد العمليه الان",_key,msg.id_)
return false
else
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' ❦︎︙ هوا الخنزير دا اللي ضافك 😂🙂↫ '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' ❦︎︙ انت دخلت عبر رابط الروم يقمر 🙊💕') 
end
end,nil)
else
...
Text = ' ❦︎︙ بالتاكيد تم تفعيل امر التحقق'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n ❦︎︙ تم تعطيل امر التحقق'
else
Text = '\n ❦︎︙ بالتاكيد تم تعطيل امر التحقق'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "صورتي"  then
...
if Num == 0 then 
Text = ' ❦︎︙ يوه منت مضفتش حد يستا'
else
Text = ' ❦︎︙ عدد جهاتك يبشا *↫ { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" ❦︎︙ تم تنزيلك من جميع الرتب")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" ❦︎︙︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" ❦︎︙︙البوت ليس ادمن يرجى ترقيتي !*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" ❦︎︙︙عذرا لا استطيع طرد ادمنية الكروب*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(" ❦︎︙︙تم الطرد بنجاح*")..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
end,nil)   
end
if Text == 'noKikedMe'..data.sender_user_id_ then  
local Text ="❦︎︙ تم الغاء الأمر بنجاح "
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ ɴᴏᴠᴀ',url='http://t.me/SO_NOVA'}},
}
...
local Text ="❦︎︙ ارسل الاذاعة لارسلها الي الجروبات "
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ ɴᴏᴠᴀ',url='http://t.me/SO_NOVA'}},
}
...
local Text ="❦︎︙ ارسل الاذاعة لارسلها الي المشتركين "
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'sᴏᴜʀᴄᴇ ɴᴏᴠᴀ',url='http://t.me/SO_NOVA'}},
}
