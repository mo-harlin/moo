...
if text == 'محمد' or text == 'هارلين' or text == 'محمد هارلين' then
local Text = [[
...
if text == 'تايجر' or text == 'تايجر الهكر' or text == 'تايجر الهقر' or text == 'مطور السورس' then
local Text = [[
تايجر مطور سورس جاك لوحابب تتواصل معاه ❤️.
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = 'ᴠ ᴛɪɢᴇʀ', url="t.me/Oo_tiger"}},
{{text = 'sᴏᴜʀᴇ ᴊᴀᴄᴋ', url="t.me/Source_JACK"}},
}
local msg_id = msg.id_/2097152/0.5
...
' }\n'..' ᥀︙  الايدي بالصوره  ⇇{ '..idph..
' }\n'..' ᥀︙  الرفع  ⇇{ '..setadd..
' }\n'..' ᥀︙  الحظر  ⇇{ '..banm..' }\n\n ᥀︙═───═❲[sᴏᴜʀᴇ ᴊᴀᴄᴋ](t.me/Source_JACK)❳═───═ ᥀︙\n ᥀︙ قناة سورس جاك◍- - - - - - - -×- - - - - - - -◍\n [ ❲[sᴏᴜʀᴇ ᴊᴀᴄᴋ](t.me/Source_JACK)❳](t.me/Source_JACK) \n'
send(msg.chat_id_, msg.id_,text)     
end
